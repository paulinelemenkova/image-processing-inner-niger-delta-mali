...
plot(savi, col = rev(brewer.pal(11, "Spectral")), font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20151116_20200908_02_T1_SR: Inner Niger Delta, Mali (2015)", cex.main=0.9)
