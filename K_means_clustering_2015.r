...
Landsat_2015_stack <- stack(Landsat_2015)
# Turning a stack into a brick. 
Landsat_2015_brick <- brick(Landsat_2015_stack)
# Viewing brick attributes
Landsat_2015_brick
#
# Running the classification
set.seed(25)
unC <- unsuperClass(Landsat_2015_brick, nSamples = 100, nClasses = 20, nStarts = 5)
unC
#
...
# plotting a map
plot(unC$map, main = "K-means Clustering for Landsat-8 OLI/TIRS C1 image of Mali, Inner Niger Delta  \nLC08_L2SP_197050_20151116_20200908_02_T1_SR (2015)", font.main=1, cex.main = 0.85, col = colors, axes = FALSE, box = FALSE, legend = FALSE)
# adding legend
