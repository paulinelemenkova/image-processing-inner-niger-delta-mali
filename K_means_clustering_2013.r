...
Landsat_2013_stack <- stack(Landsat_2013)
# Turning a stack into a brick. 
Landsat_2013_brick <- brick(Landsat_2013_stack)
# Viewing brick attributes
Landsat_2013_brick
#
# Running the classification
set.seed(25)
unC <- unsuperClass(Landsat_2013_brick, nSamples = 100, nClasses = 20, nStarts = 5)
unC
#
# Creating color palette
colors <- jet(20)
# plotting a map
plot(unC$map, main = "K-means Clustering for Landsat-8 OLI/TIRS C1 image of Mali, Inner Niger Delta  \nLC08_L2SP_197050_20131110_20200912_02_T1_SR (2013)", font.main=1, cex.main = 0.85, col = colors, axes = FALSE, box = FALSE, legend = FALSE)
# adding legend
