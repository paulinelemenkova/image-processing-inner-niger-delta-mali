...
# Importing data
Landsat_2020 <- list.files("/Users/polinalemenkova/Documents/R/52_Image_Processing/K-means")
# Printing the list
list.files()
#
# Stacking the data to create a RasterStack. 
Landsat_2020_stack <- stack(Landsat_2020)
# Turning a stack into a brick. 
Landsat_2020_brick <- brick(Landsat_2020_stack)
# Viewing brick attributes
Landsat_2020_brick
#
# Running the classification
set.seed(25)
unC <- unsuperClass(Landsat_2020_brick, nSamples = 100, nClasses = 20, nStarts = 5)
unC
#
...
# plotting a map
plot(unC$map, main = "K-means Clustering for Landsat-8 OLI/TIRS C1 image of Mali, Inner Niger Delta  \nLC08_L2SP_197050_20201129_20210316_02_T1_SR_B5 (2020)", font.main=1, cex.main = 0.85, col = colors, axes = FALSE, box = FALSE, legend = FALSE)
# adding legend
