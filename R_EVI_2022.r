...
plot(evi2, col = colors, font.main = 2, main = "Enhanced Vegetation Index 2 (EVI2) for Landsat-8 OLI/TIRS C1 image LC09_L2SP_197050_20221111_20221113_02_T1: Inner Niger Delta, Mali (2022)", cex.main=0.9)
minor.tick(nx = 10, ny = 10, tick.ratio = 0.3)
# Computing histogram for EVI2
hist(evi2, font.main = 1, main = "EVI2 values for Landsat-9 OLI/TIRS C1 image \n LC09_L2SP_197050_20221111_20221113_02_T1, Inner Niger Delta, Mali (2022)", xlab = "SAVI", ylab= "Frequency",
