...
plot(ndvi, col=brewer.pal(11, "RdYlGn"), font.main = 1, main = "NDVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20181124_20200830_02_T1_SR: Inner Niger Delta, Mali (2018)", cex.main=0.9)
