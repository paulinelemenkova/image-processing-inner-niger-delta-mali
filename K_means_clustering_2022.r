...
# Importing data
Landsat_2022 <- list.files("/Users/polinalemenkova/Documents/R/52_Image_Processing/K-means")
# Printing the list
list.files()
#
# Stacking the data to create a RasterStack. 
Landsat_2022_stack <- stack(Landsat_2022)
# Turning a stack into a brick. 
Landsat_2022_brick <- brick(Landsat_2022_stack)
# Viewing brick attributes
Landsat_2022_brick
#
# Running the classification
set.seed(25)
unC <- unsuperClass(Landsat_2022_brick, nSamples = 100, nClasses = 20, nStarts = 5)
unC
#
...
colors <- rainbow(20)
# plotting a map
plot(unC$map, main = "K-means Clustering for Landsat-8 OLI/TIRS C1 image of Mali, Inner Niger Delta  \nLC09_L2SP_197050_20221111_20221113_02_T1_SR (2022)", font.main=1, cex.main = 0.85, col = colors, axes = FALSE, box = FALSE, legend = FALSE)
# adding legend
