...
# colors <- stepped()
# plot(savi, col = colors, font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20181110_20200912_02_T1_SR: Inner Niger Delta, Mali (2018)", cex.main=0.9)
# plot(savi, col = brewer.pal(11, "PiYG"), font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20181110_20200912_02_T1_SR: Inner Niger Delta, Mali (2018)", cex.main=0.9)
plot(savi, col = rev(brewer.pal(11, "Spectral")), font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20181124_20200830_02_T1_SR: Inner Niger Delta, Mali (2018)", cex.main=0.9)
minor.tick(nx = 10, ny = 10, tick.ratio = 0.3)
# Plotting histogram of the NDVI
hist(savi, font.main = 1, main = "SAVI values for Landsat-8 OLI/TIRS C1 image \nLC08_L2SP_197050_20181124_20200830_02_T1_SR: Inner Niger Delta, Mali (2018)", xlab = "NDVI", ylab= "Frequency",
