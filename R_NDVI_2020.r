...
plot(ndvi, col=brewer.pal(11, "RdYlGn"), font.main = 1, main = "NDVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20201129_20210316_02_T1_SR: Inner Niger Delta, Mali (2020)", cex.main=0.9)
