...
plot(savi, col = rev(brewer.pal(11, "Spectral")), font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20201129_20210316_02_T1_SR: Inner Niger Delta, Mali (2020)", cex.main=0.9)
minor.tick(nx = 10, ny = 10, tick.ratio = 0.3)
# Plotting the histogram of SAVI
hist(savi, font.main = 1, main = "SAVI values for Landsat-8 OLI/TIRS C1 image \nLC08_L2SP_197050_20201129_20210316_02_T1_SR: Inner Niger Delta, Mali (2020)", xlab = "NDVI", ylab= "Frequency",
