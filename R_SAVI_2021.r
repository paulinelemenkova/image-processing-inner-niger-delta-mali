...
plot(savi, col = rev(brewer.pal(11, "Spectral")), font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20211116_20211125_02_T1_SR: Inner Niger Delta, Mali (2021)", cex.main=0.9)
