...
# colors <- stepped()
# plot(savi, col = colors, font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20131110_20200912_02_T1_SR: Inner Niger Delta, Mali (2013)", cex.main=0.9)
# plot(savi, col = brewer.pal(11, "PiYG"), font.main = 1, main = "SAVI for Landsat-8 OLI/TIRS C1 image LC08_L2SP_197050_20131110_20200912_02_T1_SR: Inner Niger Delta, Mali (2013)", cex.main=0.9)
